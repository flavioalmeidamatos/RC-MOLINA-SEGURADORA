            ...
            <div className="overflow-y-auto custom-scrollbar p-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                {[
                  ...
                  { name: "ASSIM SAUDE", url: "https://assim.hcommerce.com.br/login", logo: "/portais/assim_saude.webp", executeScript: "setTimeout(() => { const setValue = (el, value) => { if (!el) return; const setter = Object.getOwnPropertyDescriptor(Object.getPrototypeOf(el), 'value')?.set; setter ? setter.call(el, value) : el.value = value; el.dispatchEvent(new Event('input', { bubbles: true })); el.dispatchEvent(new Event('change', { bubbles: true })); }; const fields = Array.from(document.querySelectorAll('input')); const user = document.getElementById('login_usuario') || document.getElementById('usuario') || document.getElementById('username') || document.querySelector('input[name=\"login\"], input[name=\"usuario\"], input[name=\"username\"], input[type=\"email\"], input[type=\"text\"]'); const pass = document.getElementById('login_senha') || document.getElementById('senha') || document.getElementById('password') || document.querySelector('input[name=\"senha\"], input[name=\"password\"], input[type=\"password\"]'); setValue(user, '77915445715'); setValue(pass, 'cfqqho'); }, 1500);" },
