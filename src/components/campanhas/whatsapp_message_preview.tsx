  ...
  return (
    <section className="h-full flex flex-col overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm">
      ...
      <div className="p-4 flex-1 flex flex-col min-h-0 bg-slate-50/30 justify-center">
        <div className="mx-auto w-full max-w-[360px] flex-1 flex flex-col min-h-0 rounded-[32px] bg-[#111b21] p-3 shadow-[0_24px_60px_rgba(15,23,42,0.18)]">
          <div className="overflow-hidden flex-1 flex flex-col min-h-0 rounded-[28px] bg-[#efeae2]">
            <div className="flex flex-wrap items-center gap-1.5 bg-[#202c33] px-3.5 py-2.5 text-white shrink-0">
              <button
                type="button"
                onClick={onSend}
