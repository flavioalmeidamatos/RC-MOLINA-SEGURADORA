  ...
  return (
    ...
    >
      ...
      <div className="space-y-3 p-3">
        <div className="rounded-2xl border border-dashed border-slate-200 bg-slate-50/80 px-3 py-2">
          ...
          <p className="mt-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-black">
          ...
          <div className="flex flex-wrap gap-2">
            {attachments.map((attachment) => {
              ...
              return (
                <article
                  key={attachment.id}
                  className="flex w-fit max-w-[240px] min-w-[150px] items-center justify-between gap-2.5 rounded-xl border border-slate-200 bg-slate-50/80 p-2 shadow-sm transition-all duration-200 hover:border-slate-300 hover:bg-slate-100/60"
                >
                  <div className="flex min-w-0 items-center gap-2">
                    <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-white text-[#b58c2a] shadow-xs ring-1 ring-slate-200/80">
                      <AttachmentIcon size={14} strokeWidth={1.7} />
                    </div>
                    <div className="min-w-0 pr-1">
                      <p className="truncate text-xs font-black text-[#0c1826]" title={attachment.name}>
                        {attachment.name}
                      </p>
                      <p className="mt-0.5 text-[9px] font-semibold uppercase tracking-wider text-slate-400">
                        {attachment.kind} | {attachment.sizeLabel}
                      </p>
                      <p className="mt-0.5 text-[9px] font-semibold text-emerald-700 leading-none">
                        {attachment.fileUrl ? "Salvo" : "Pendente"}
                      </p>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-400 transition hover:border-slate-300 hover:bg-slate-50 hover:text-slate-600 focus:outline-none"
