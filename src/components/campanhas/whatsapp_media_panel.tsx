  ...
  return (
    ...
    >
      <div className="border-b border-slate-100 bg-slate-50/80 px-5 py-4">
        <div className="flex items-start justify-between gap-4">
          ...
          <button
            ...
            className="rounded-full border border-slate-200 bg-white px-4 py-2.5 text-[11px] font-black uppercase tracking-[0.18em] text-slate-600 transition hover:border-slate-300 hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-60"
          >
      ...
      <div className="space-y-4 p-5">
        <div className="rounded-[22px] border border-dashed border-slate-200 bg-slate-50/80 px-4 py-4">
        ...
        {attachments.length === 0 ? (
          <div className="rounded-[22px] border border-slate-200 bg-white px-4 py-6 text-center">
            <Paperclip className="mx-auto text-slate-300" size={24} strokeWidth={1.6} />
          ...
          <div className="space-y-3">
            {attachments.map((attachment) => {
              ...
              return (
                <article
                  key={attachment.id}
                  className="flex items-center justify-between gap-3 rounded-[22px] border border-slate-200 bg-slate-50/80 px-4 py-4"
                >
                  <div className="flex min-w-0 items-center gap-3">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-white text-[#b58c2a] shadow-sm ring-1 ring-slate-200">
                  ...
                  <button
                    ...
                    className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-400 transition hover:border-slate-300 hover:text-slate-600"
