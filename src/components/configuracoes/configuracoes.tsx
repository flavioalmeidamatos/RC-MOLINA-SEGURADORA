  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="grid grid-cols-1 2xl:grid-cols-2 gap-6 w-full max-w-[1600px] mx-auto items-stretch">
          {/* Coluna Esquerda: Scanner */}
          <div className="flex flex-col bg-white border border-slate-200 rounded-xl p-5 shadow-sm min-h-[600px] h-full">
