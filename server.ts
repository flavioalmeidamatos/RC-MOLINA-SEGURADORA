...
import { aniversariantesMesHandler, createClienteHandler, listClientesHandler, listClientesByStatusHandler, nextClienteCodigoHandler, searchClientesHandler, updateClienteHandler, deleteClienteHandler, clientStatsHandler, clientProdutosStatsHandler, clientNegociacaoStatsHandler, listClientesByNegociacaoHandler, checkClienteCodigoHandler, addClienteAnexoHandler } from './api/clientes';
...
async function startServer() {
  ...
  app.get('/api/clientes/check-codigo/:codigo', checkClienteCodigoHandler);
  app.get('/api/clientes/status', listClientesByStatusHandler);
  app.get('/api/clientes/stats', clientStatsHandler);
  app.get('/api/clientes/produtos-stats', clientProdutosStatsHandler);
  app.get('/api/clientes/negociacao-stats', clientNegociacaoStatsHandler);
  app.get('/api/clientes/by-negociacao', listClientesByNegociacaoHandler);
